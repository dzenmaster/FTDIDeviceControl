...
#define		UartCmd_get_pkg_len()			(IORD_32DIRECT(AVS_UART_CMD_0_BASE, AVS_PACKAGE_TYPE_LEN_RD_ADDR) & 0x0000FFFF)
#define		UartCmd_get_pkg_type()			(IORD_32DIRECT(AVS_UART_CMD_0_BASE, AVS_PACKAGE_TYPE_LEN_RD_ADDR) >> 16)
